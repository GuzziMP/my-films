  ...
  public class ThumbCreator
  {
    ...
    public static bool CreateVideoThumb(string aVideoPath, string aThumbPath, bool aCacheThumb, bool aOmitCredits, int columns, int rows, bool doShareThumb, string imageType)
    {
      ...
      try
      {
        ...
        {
          if (Picture.CreateThumbnail(shareThumb, aThumbPath, (int)MediaPortal.Util.Thumbs.ThumbResolution, (int)MediaPortal.Util.Thumbs.ThumbResolution, 0, false))
            Picture.CreateThumbnail(shareThumb, Utils.ConvertToLargeCoverArt(aThumbPath), (int)MediaPortal.Util.Thumbs.ThumbLargeResolution, (int)MediaPortal.Util.Thumbs.ThumbLargeResolution, 0, false);
        }
      ...
      {
        LogMyFilms.Error(ex, "VideoThumbCreator: Thumbnail generation failed - {0}!", ex.Message);
      }
      if (File.Exists(aThumbPath))
      {
        return true;
